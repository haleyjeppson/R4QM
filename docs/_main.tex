...
\begin{Shaded}
\begin{Highlighting}[]
\DocumentationTok{\#\# add model residuals}
\NormalTok{fa\_models }\OtherTok{\textless{}{-}}\NormalTok{ obs\_long }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{resid1 =} \FunctionTok{c}\NormalTok{(model1}\SpecialCharTok{$}\NormalTok{residual),}
         \AttributeTok{resid2 =} \FunctionTok{c}\NormalTok{(model2}\SpecialCharTok{$}\NormalTok{residual),}
         \AttributeTok{resid3 =} \FunctionTok{c}\NormalTok{(model3}\SpecialCharTok{$}\NormalTok{residual)) }
\NormalTok{fa\_models}
\end{Highlighting}
\end{Shaded}
