...
R is based on the statistical programming language S and can be downloaded for free from [www.r-project.org](https://www.r-project.org/). Currently, to do so, choose: CRAN, then a mirror site in the US, then Download R for Windows, then base, then "Download R 4.3.0 for Windows". This page also has links to FAQs and other information about R.
